...
class DARKTileService : TileService() {

    companion object {
        private const val TAG = "DARKTileService"
        ...
        @Volatile
        private var instanceRef: java.lang.ref.WeakReference<DARKTileService>? = null
        ...
        fun refreshTile(ctx: android.content.Context) {
            ...
            try {
                ...
                requestListeningState(
                    ctx,
                    ComponentName(ctx, DARKTileService::class.java),
                )
            } catch (e: Throwable) {
    ...
    private fun renderTile(override: VpnStatus? = null) {
        ...
        try {
            tile.icon = Icon.createWithResource(this, R.drawable.ic_dark_tile)
        } catch (_: Exception) {
